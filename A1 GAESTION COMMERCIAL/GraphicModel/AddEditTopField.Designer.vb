...
Partial Class AddEditTopField
    ...
    Private Sub InitializeComponent()
        ...
        Me.CB.ItemHeight = 13
        Me.CB.Items.AddRange(New Object() {"*", "*Titre", "id", "date", "cid", "name", "CLT_ice", "CLT_adresse", "CLT_ref", "total_ht", "total_tva", "total_ttc", "total_remise", "droitTimbre", "Avance", "Editeur", "//Total_en_Chiffre", "MPayement"})
        ...
        Me.txt.Size = New System.Drawing.Size(328, 35)
        Me.txt.StartUp = 2
        Me.txt.TabIndex = 4
        Me.txt.TextSize = 8
